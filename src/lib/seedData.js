...
const CO_COMPANY_BASES = [
  'Tecnologías', 'Soluciones', 'Servicios', 'Constructora', 'Distribuidora',
  'Comercializadora', 'Consultores', 'Ingenieros', 'Logística', 'Inversiones',
  'Suministros', 'Asesores', 'Grupo', 'Industrias', 'Innovación',
];
const CO_COMPANY_NAMES = [
  'Andina', 'Bolívar', 'Cundinamarca', 'Pacífico', 'Caribe', 'Sabana',
  'Aburrá', 'Magdalena', 'Tequendama', 'Tayrona', 'Eldorado', 'Bacatá',
  'Cafetera', 'Llanera', 'Boyacense',
];
const CO_CITIES = [
 ...
 */
export function generateDemoInvoices(count = 50) {
  const invoices = [];
  // Distribuir uniformemente en 6 meses
  for (let i = 0; i < count; i++) {
    const monthsAgo = i % 6; // 0..5 ciclando → cada mes recibe ~count/6 facturas
    ...
    const invoice = {
      id: `demo-${i}-${Date.now()}`,
      invoice_number: `FE-${String(i + 1).padStart(4, '0')}`,
...
export function getDIANCalendar2025() {
  ...
  const ivaJanFeb = ['2025-03-11', '2025-03-12', '2025-03-13', '2025-03-14', '2025-03-17',
                     '2025-03-18', '2025-03-19', '2025-03-20', '2025-03-21', '2025-03-24'];
  ivaJanFeb.forEach((d, i) => cal.push({
    obligation: 'Declaración IVA Bimestral', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
    due_date: d, description: 'Bimestre Ene-Feb 2025',
  }));

  // Bimestre Mar-Abr → vence mayo
  const ivaMarApr = ['2025-05-13', '2025-05-14', '2025-05-15', '2025-05-16', '2025-05-19',
                     '2025-05-20', '2025-05-21', '2025-05-22', '2025-05-23', '2025-05-26'];
  ivaMarApr.forEach((d, i) => cal.push({
    obligation: 'Declaración IVA Bimestral', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
    due_date: d, description: 'Bimestre Mar-Abr 2025',
  }));

  // Bimestre May-Jun → vence julio
  const ivaMayJun = ['2025-07-08', '2025-07-09', '2025-07-10', '2025-07-11', '2025-07-14',
                     '2025-07-15', '2025-07-16', '2025-07-17', '2025-07-18', '2025-07-21'];
  ivaMayJun.forEach((d, i) => cal.push({
    obligation: 'Declaración IVA Bimestral', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
    due_date: d, description: 'Bimestre May-Jun 2025',
  }));

  // ─── RETENCIÓN EN LA FUENTE — MENSUAL ───────────────────
  const retencionMeses = [
    { d: ['2025-02-11', '2025-02-12', '2025-02-13', '2025-02-14', '2025-02-17',
          '2025-02-18', '2025-02-19', '2025-02-20', '2025-02-21', '2025-02-24'], desc: 'Enero 2025' },
    { d: ['2025-03-11', '2025-03-12', '2025-03-13', '2025-03-14', '2025-03-17',
          '2025-03-18', '2025-03-19', '2025-03-20', '2025-03-21', '2025-03-24'], desc: 'Febrero 2025' },
    { d: ['2025-04-09', '2025-04-10', '2025-04-11', '2025-04-14', '2025-04-15',
          '2025-04-16', '2025-04-21', '2025-04-22', '2025-04-23', '2025-04-24'], desc: 'Marzo 2025' },
    { d: ['2025-05-13', '2025-05-14', '2025-05-15', '2025-05-16', '2025-05-19',
          '2025-05-20', '2025-05-21', '2025-05-22', '2025-05-23', '2025-05-26'], desc: 'Abril 2025' },
    { d: ['2025-06-10', '2025-06-11', '2025-06-12', '2025-06-13', '2025-06-16',
          '2025-06-17', '2025-06-18', '2025-06-19', '2025-06-20', '2025-06-24'], desc: 'Mayo 2025' },
    { d: ['2025-07-08', '2025-07-09', '2025-07-10', '2025-07-11', '2025-07-14',
          '2025-07-15', '2025-07-16', '2025-07-17', '2025-07-18', '2025-07-21'], desc: 'Junio 2025' },
  ];
  retencionMeses.forEach(({ d, desc }) => {
    d.forEach((dd, i) => cal.push({
      obligation: 'Retención en la Fuente', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
      due_date: dd, description: desc,
    }));
  });

  // ─── DECLARACIÓN DE RENTA — PERSONAS JURÍDICAS ──────────
  const renta = ['2025-05-13', '2025-05-14', '2025-05-15', '2025-05-16', '2025-05-19',
                 '2025-05-20', '2025-05-21', '2025-05-22', '2025-05-23', '2025-05-26'];
  renta.forEach((d, i) => cal.push({
    obligation: 'Declaración de Renta', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
    due_date: d, description: 'Año gravable 2024 — Personas Jurídicas',
  }));

  // ─── INFORMACIÓN EXÓGENA 2024 ───────────────────────────
  const exogena = ['2025-05-09', '2025-05-12', '2025-05-13', '2025-05-14', '2025-05-15',
                   '2025-05-16', '2025-05-19', '2025-05-20', '2025-05-21', '2025-05-22'];
  exogena.forEach((d, i) => cal.push({
    obligation: 'Información Exógena', nit_last_digit: i + 1 > 9 ? 0 : i + 1,
    due_date: d, description: 'Reporte año 2024',
  }));

  // ─── ICA BOGOTÁ — BIMESTRAL 2025 ────────────────────────
  cal.push({ obligation: 'Declaración ICA Bogotá', nit_last_digit: 0, due_date: '2025-03-21', description: 'Bimestre Ene-Feb 2025' });
  cal.push({ obligation: 'Declaración ICA Bogotá', nit_last_digit: 0, due_date: '2025-05-23', description: 'Bimestre Mar-Abr 2025' });
  cal.push({ obligation: 'Declaración ICA Bogotá', nit_last_digit: 0, due_date: '2025-07-18', description: 'Bimestre May-Jun 2025' });
